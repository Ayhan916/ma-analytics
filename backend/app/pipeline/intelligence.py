...
_FEATURE_KEYWORDS: dict[str, list[str]] = {
    ...
    "Login":        ["login", "anmelden", "einloggen", "anmeldung", "passwort", "password", "pin", "registrierung", "bmw id", "bmw-id"],
    "Updates":      ["update", "aktualisierung", "upgrade", "patch"],
    "Performance":  ["absturz", "crash", "stürzt", "abstürzen", "einfriert", "eingefroren", "friert", "hängt sich", "reagiert nicht"],
